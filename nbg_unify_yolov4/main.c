...
{
    return vnn_PostProcessYolov4( graph );
}
    ...
    )
{
    ...
    if(vnn_UseImagePreprocessNode())
    {
        return vnn_PreProcessYolov4_ImageProcess(graph, inputs, input_num);
    }
    */
    return vnn_PreProcessYolov4( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolov4( data_file_name, NULL,
